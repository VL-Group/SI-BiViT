...
class PatchEmbed(nn.Module):
    ...
    def __init__(
        ...
        stridd = to_2tuple(patch_size // 2)
        patch_size = to_2tuple(patch_size) # modify
        ...
        self.proj = nn.Conv2d(in_chans, embed_dim, kernel_size=patch_size, stride=patch_size, bias=bias, ) # modify
